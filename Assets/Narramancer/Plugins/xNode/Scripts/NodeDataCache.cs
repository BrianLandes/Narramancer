    ...
    public static class NodeDataCache {
        ...
        private static void BuildCache() {
            ...
            foreach (Assembly assembly in assemblies) {
                ...
                Assert.IsTrue(!string.IsNullOrEmpty(assemblyName));
                switch (assemblyName) {
                    ...
                    default:
                        ...
                        var nonAbstractTypes = types.Where(t => !t.IsAbstract && baseType.IsAssignableFrom(t));
                        nodeTypes.AddRange(nonAbstractTypes.ToArray());
                        break;
                }
            }
